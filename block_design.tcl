...
cell base:user:diff_out_buf:1.0 cs_o_buf {
  DIFF_BUF_WIDTH 1
} {
...
cell base:user:diff_out_buf:1.0 spi_clk_o_buf {
  DIFF_BUF_WIDTH 1
} {
...
cell base:user:diff_out_buf:1.0 ldac_o_buf {
  DIFF_BUF_WIDTH 1
} {
  d_in ldac_inv/Res
  diff_out_p ldac_o_p
...
cell base:user:diff_out_buf:1.0 dac_mosi_o_buf {
  DIFF_BUF_WIDTH 4
} {
